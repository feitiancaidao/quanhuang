...
void Boss1::SeekRole()
{
    ...
    CCCallFunc* call = CCCallFunc::create((Boss1*)this, callfunc_selector(Boss1::SeekRoleCallback));
...
void Boss1::getUp()
{
    ...
    CCCallFunc* call = CCCallFunc::create((Boss1*)this, callfunc_selector(Boss1::getUpCallBack));
...
void Boss1::wander()
{
    ...
    setAction(1);
    CCCallFunc* flipx = CCCallFunc::create((Boss1*)this,  callfunc_selector(Boss1::WanderCallback));
...
void Boss2::getUp()
{
    ...
    CCCallFunc* callfunc = CCCallFunc::create((Boss2*)this, callfunc_selector(Boss2::getUpCallBack));
...
void Boss2::wander()
{
    ...
    setAction(1);
    CCCallFunc* flipx = CCCallFunc::create((Boss2*)this,  callfunc_selector(Boss2::WanderCallback));
    this->runAction(flipx);
}
...
void Boss2::WanderCallback()
{
    ...
    CCCallFunc* flipx = CCCallFunc::create((Monster*)this,  callfunc_selector(Monster::WanderCallback));
    CCSequence* sequence = CCSequence::create(moveTo,flipx,NULL);
    sequence->setTag(WanderTag);
    runAction(sequence);
}
...
void Boss4::wander()
{
    ...
    setAction(1);
    CCCallFunc* flipx = CCCallFunc::create((Boss4*)this,  callfunc_selector(Boss4::WanderCallback));
    this->runAction(flipx);
}
