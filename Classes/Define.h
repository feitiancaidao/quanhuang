...
#define CONSTAMT
/** 胖子 */
 static const int NPC1 = 0X0001;
/** 刀子 */
 static const int NPC2 = 0X0002;
/** 棒子 */
 static const int NPC3 = 0X0003;
/** 火枪 */
 static const int NPC4 = 0X0004;
/** 打拳d */
 static const int NPC5 = 0X0005;
/** 打拳e */
 static const int NPC6 = 0X0006;
/** 弹弓 */
 static const int NPC7 = 0X0007;
/** 打拳a */
 static const int NPC8A = 0X0008;
/** 打拳b */
 static const int NPC8B = 0X0009;
/** 打拳c */
 static const int NPC8C = 0X0010;
 static const int BOSS1 = 0X0011;
 static const int BOSS2 = 0X0012;
 static const int BOSS3 = 0X0013;
 static const int BOSS4 = 0X0014;
 static const int BOSS5 = 0X0015;
#endif
...
{
  "","","琼","混混","混混","混混","女混混","琼","混混首领","琼","琼","邪恶教主","邪恶教主","琼","琼","琼","琼","琼","琼","琼","琼",
};

static std::string juqingMapText[21] =
{
    "",""," 别浪费时间了,你们一起上吧!杀光了你们我还要赶路呢!","还真敢追过来？给我干死他！", "组织会为我报仇的！！！"," 兄弟们上啊!妈的竟然敢追到这里！","真帅呢! 让我来配他你玩儿一会儿吧~!","你们这帮恶棍，把小舞还给我！","没想到你能走到这里，但是！也就到此为止了！今日就是你的死期了。","混混也有礼拜堂?让我直接超度你们吧！","还有谁?! 都死完了么?! ","总有些不知死活的送上门来","竟敢亵渎我们神圣的组织…不可饶恕！","我是黯月之血继承者，去后悔你们惹火了我吧!","如果将一切都烧尽的话, 不就干净了么?","我的能力是时候完全释放了。","你还没有被干掉吗?","这就是最后的总部? 想放抗么? 真无聊!","哭吧,叫吧,然后就死吧! 到此为止了!","啊啊啊啊啊啊！谁也无法阻挡我","你们成功的为了自己挖好了坟墓，让我来结束这一切。"
};
